...
<body class="<?= $site->navigationtype() ?> bg-init">

    <div class="animsition-overlay-slide"></div>

    <?php if( (s::get('device_class') == 'mobile') || (s::get('device_class') == 'tablet') || ($site->navigationtype() == 'navoffcanvas' ) ): ?>
    <nav class="offcanvas">
        <?php snippet('menu') ?>
    </nav>
    <?php endif; ?>
    ...
    <div id="canvas">
        ...
        <header class="header cf" role="banner">
            <div class="wrap">
                ...
                <?php if( (s::get('device_class') == 'desktop') && ($site->navigationtype() == 'navstandard' ) ): ?>
                    <?php snippet('menu') ?>
                <?php endif; ?>
